...
_G.packer_plugins = {
  ...
  ["onedark.nvim"] = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/onedark.nvim",
  ...
  ["vim-closer"] = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/vim-closer",
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
